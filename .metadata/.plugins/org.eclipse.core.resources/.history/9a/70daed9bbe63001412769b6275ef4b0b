...
public:
	...
	vector<string> refData { "ram", "memory", "keyboard", "cpu", "gpu", "mouse",
			"monitor", "usb", "wireless", "ssd", "DVD", "LCD", "VGA",
			"bluetooth", "HDMI", "speakers", "videocam", "microphone", "power",
			"firewire" };
...
TEST_CASE_METHOD(TreeTest, "level order") {
	...
	vector<string> expected { "ram", "memory", "usb", "keyboard", "mouse",
			...
			"videocam", "DVD", "gpu", "microphone", "LCD", "firewire", "HDMI",
			"VGA", "bluetooth" };
